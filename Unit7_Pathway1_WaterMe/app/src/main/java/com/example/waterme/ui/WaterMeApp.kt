...
import com.example.waterme.ONE_MIN
import com.example.waterme.THREE_MIN
import com.example.waterme.TWO_MIN
...
fun ReminderDialogContent(
    ...
    val reminders = listOf(
        ...
        Reminder(R.string.one_min, ONE_MIN, TimeUnit.MINUTES, plantName),
        Reminder(R.string.two_min, TWO_MIN, TimeUnit.MINUTES, plantName),
        Reminder(R.string.three_min, THREE_MIN, TimeUnit.MINUTES, plantName)
    )
